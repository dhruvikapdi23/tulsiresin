...
import '../common/data_mapping.dart';
...
class Product {
  ...
  ///----FLUXSTORE LISTING----///
  Product({String? id, String? sku, String? name, String? status, String? vendor, String? description, String? shortDescription, String? permalink, String? price, String? regularPrice, String? salePrice, String? maxPrice, String? minPrice, bool? onSale, bool? inStock, double? averageRating, int? totalSales, String? dateOnSaleFrom, String? dateOnSaleTo, int? ratingCount, List<String>? images, String? imageFeature, List<ProductAttribute>? attributes, List<Attribute>? defaultAttributes, List<ProductAttribute>? infors, String? categoryId, String? videoUrl, List<dynamic>? groupedProducts, List<String?>? files, int? stockQuantity, int? minQuantity, int? maxQuantity, bool? manageStock, bool? backOrdered, String? relatedIds, bool? backordersAllowed, Store? store, List<Tag>? tags, List<Category>? categories, List<Map<String, dynamic>>? metaData, List<ProductAddons>? addOns, List<AddonsOption>? selectedOptions, List<VendorAdminVariation>? vendorAdminVariations, List<ProductVariation>? variationProducts, bool? isPurchased, bool? isDownloadable, String? type, String? affiliateUrl, List<ProductVariation>? variations, List<Map<String, dynamic>>? options, BookingModel? bookingInfo, String? idShop, bool? isFeatured, String? vendorAdminImageFeature, List<String>? categoryIds, List<ProductAttribute>? vendorAdminProductAttributes, String? distance, Map? pureTaxonomies, List? reviews, String? featured, bool? verified, String? tagLine, String? priceRange, String? categoryName, String? hours, String? location, String? phone, String? facebook, String? email, String? website, String? skype, String? whatsapp, String? youtube, String? twitter, String? instagram, String? eventDate, String? rating, int? totalReview, double? lat, double? long, List<dynamic>? listingMenu, ListingSlots? slots, bool? isRestricted});
  ...
  bool canBeAddedToCartFromList({bool? enableBottomAddToCart}) {
    if (enableBottomAddToCart ?? isEnableBottomAddToCart) {
      return !isEmptyProduct() && ((inStock != null && inStock!) || backordersAllowed) && type != 'external' && type != 'booking' && type != 'grouped' && (addOns?.isEmpty ?? true);
    } else {
      return !isEmptyProduct() && ((inStock != null && inStock!) || backordersAllowed) && type != 'variable' && type != 'appointment' && type != 'external' && type != 'booking' && type != 'grouped' && (addOns?.isEmpty ?? true);
    }
  }
  ...
  String? get displayPrice {
    return onSale == true ? (isNotBlank(salePrice) ? salePrice ?? '0' : price) : (isNotBlank(regularPrice) ? regularPrice ?? '0' : price);
  }

  List<Category> get distinctCategories {
    final temp = categories.map((e) => e.name).toSet().toList();
    return temp.map((e) => categories.firstWhere((element) => element.name == e)).toList();
  }
  ...
  Product.cloneFrom(Product p) {
    ...
    tags = p.tags.toList();
    defaultAddonsOptions = Map<String, Map<String, AddonsOption>>.from(jsonDecode(jsonEncode(p.defaultAddonsOptions)));
  ...
  Product.fromJson(Map<String, dynamic> parsedJson) {
    try {
      ...
      regularPrice = isNotBlank(parsedJson['regular_price'].toString()) ? parsedJson['regular_price'].toString() : null;
      salePrice = isNotBlank(parsedJson['sale_price'].toString()) ? parsedJson['sale_price'].toString() : null;
      ...
      if (isVariableProduct) {
        ...
        if (regularPrice != null && regularPrice != 'null') {
          onSaleByPrice = price != regularPrice && double.parse(regularPrice.toString()) > double.parse(parsedJson['price'].toString());
        }

        onSale = salePrice != null && isNotBlank(parsedJson['price'].toString()) && onSaleByPrice;
      }
      ...
      backordersAllowed = (parsedJson['backorders_allowed'] ?? false) || ((parsedJson['backorders'] ?? 'no') != 'no');
      ...
      averageRating = double.tryParse(parsedJson['average_rating']?.toString() ?? '0.0') ?? 0.0;
      ratingCount = int.tryParse((parsedJson['rating_count'] ?? 0).toString()) ?? 0;
      totalSales = int.tryParse((parsedJson['total_sales'] ?? 0).toString()) ?? 0;
      ...
      categoryId = parsedJson['categories'] != null && parsedJson['categories'].length > 0 ? parsedJson['categories'][0]['id'].toString() : '0';
      ...
      if (parsedJson['attributesData'] != null) {
        try {
          parsedJson['attributesData'].forEach((element) => vendorAdminProductAttributes.add(ProductAttribute.fromJson(element)..isActive = true));
        } catch (e) {
          printLog(e);
        }
      }
      ...
      if (parsedJson['related_ids'] != null && parsedJson['related_ids'].isNotEmpty) {
        relatedIds = '';
      ...
      bool? notChecking = notStrictVisibleVariant;
        ...
        parsedJson['attributesData']?.forEach((item) {
          ...
          if (notChecking! && item['variation']) {
            ...
            if (attr.options!.isEmpty) {
              ...
              attr.options!.addAll(
                infors.firstWhereOrNull((ProductAttribute productAttribute) => productAttribute.name != null && attr.name != null && (productAttribute.name == attr.name || productAttribute.name!.toLowerCase() == attr.name!.toLowerCase() || productAttribute.name!.replaceAll('-', ' ') == attr.name!.replaceAll('-', ' ')))?.options?.map((option) => {'name': option}) ?? [],
              );
            }
      ...
      try {
        ...
        if (categoriesData != null && categoriesData is List && categoriesData.isNotEmpty) {
      ...
      if (parsedJson['category_ids'] != null) {
        if (parsedJson['category_ids'] is Map) {
          parsedJson['category_ids'].forEach((k, v) => categoryIds.add(v.toString()));
        }
        ...
        for (var item in parsedJson['meta_data']) {
          ...
          try {
            if (item['key'] == '_product_addons') {
              ...
              final List<dynamic> values = item['value'] is Map ? (item['value'] as Map).values.toList() : item['value'];
              final addOnNames = [];
              addOns = [];
          ...
          try {
            if (item['key'] == 'ihc_mb_who') {
              isRestricted = !item['value'].toString().contains('all') && item['value'].toString().isNotEmpty;
            }
          } catch (e) {
            printLog('maxQuantity $e');
          }
      ...
      if (isVariableProduct && parsedJson['variation_products'] != null) {
        try {
          variationProducts = [];
          for (var item in parsedJson['variation_products']) {
            variationProducts!.add(ProductVariation.fromJson(Map<String, dynamic>.from(item)));
          }
        } catch (e) {
  ...
  Product.fromListingJson(Map<String, dynamic> json) {
    try {
      id = Tools.getValueByKey(json, DataMapping().kProductDataMapping['id']).toString();
      name = HtmlUnescape().convert(Tools.getValueByKey(json, DataMapping().kProductDataMapping['title']));
      description = Tools.getValueByKey(json, DataMapping().kProductDataMapping['description']);
      permalink = Tools.getValueByKey(json, DataMapping().kProductDataMapping['link']);

      distance = Tools.getValueByKey(json, DataMapping().kProductDataMapping['distance']);

      pureTaxonomies = Tools.getValueByKey(json, DataMapping().kProductDataMapping['pureTaxonomies']);

      final rate = Tools.getValueByKey(json, DataMapping().kProductDataMapping['rating']);

      averageRating = rate != null ? double.parse(double.parse(double.parse(rate.toString()).toString()).toStringAsFixed(1)) : 0.0;

      regularPrice = Tools.getValueByKey(json, DataMapping().kProductDataMapping['regularPrice']);
      price = Tools.getValueByKey(json, DataMapping().kProductDataMapping['priceRange']);

      type = Tools.getValueByKey(json, DataMapping().kProductDataMapping['type']);
      categoryName = type;
      rating = Tools.getValueByKey(json, DataMapping().kProductDataMapping['rating']);
      rating = rating ?? '0.0';

      final reviews = Tools.getValueByKey(json, DataMapping().kProductDataMapping['totalReview']);
      totalReview = reviews != null && reviews != false ? int.parse(reviews.toString()) : 0;
      ratingCount = totalReview;

      location = Tools.getValueByKey(json, DataMapping().kProductDataMapping['address']);
      final la = Tools.getValueByKey(json, DataMapping().kProductDataMapping['lat']);
      final lo = Tools.getValueByKey(json, DataMapping().kProductDataMapping['lng']);
      lat = la != null && la.isNotEmpty ? double.parse(la.toString()) : null;
      long = lo != null && lo.isNotEmpty ? double.parse(lo.toString()) : null;

      phone = Tools.getValueByKey(json, DataMapping().kProductDataMapping['phone']);
      email = Tools.getValueByKey(json, DataMapping().kProductDataMapping['email']);
      skype = Tools.getValueByKey(json, DataMapping().kProductDataMapping['skype']);
      website = Tools.getValueByKey(json, DataMapping().kProductDataMapping['website']);
      whatsapp = Tools.getValueByKey(json, DataMapping().kProductDataMapping['whatsapp']);
      facebook = Tools.getValueByKey(json, DataMapping().kProductDataMapping['facebook']);
      twitter = Tools.getValueByKey(json, DataMapping().kProductDataMapping['twitter']);
      youtube = Tools.getValueByKey(json, DataMapping().kProductDataMapping['youtube']);
      instagram = Tools.getValueByKey(json, DataMapping().kProductDataMapping['instagram']);
      tagLine = Tools.getValueByKey(json, DataMapping().kProductDataMapping['tagLine']);
      eventDate = Tools.getValueByKey(json, DataMapping().kProductDataMapping['eventDate']);
      priceRange = Tools.getValueByKey(json, DataMapping().kProductDataMapping['priceRange']);
      featured = 'off';
      if (DataMapping().kProductDataMapping['featured'] != null) {
        featured = Tools.getValueByKey(json, DataMapping().kProductDataMapping['featured']);
      }
      verified = false;
      if (DataMapping().kProductDataMapping['verified'] != null) {
        String? verifyText = Tools.getValueByKey(json, DataMapping().kProductDataMapping['verified']);
        if (verifyText == 'on' || verifyText == 'claimed') {
          verified = true;
        }
      }

      var list = Tools.getValueByKey(json, DataMapping().kProductDataMapping['gallery']);
      ...
      var featureImage = Tools.getValueByKey(json, DataMapping().kProductDataMapping['featured_media']);

      if (featureImage == null || featureImage.isEmpty || featureImage is bool) {
        if (images.isEmpty) {
      ...
      if (imageFeature == kDefaultImage) {
        ...
        if (imgJson != null) {
          if (imgJson['media_details']?['sizes']?['large'] != null) {
            imageFeature = imgJson['media_details']?['sizes']?['large']?['source_url'];
            if (images.isEmpty) {
      ...
      final items = Tools.getValueByKey(json, DataMapping().kProductDataMapping['menu']);
  ...
  Product copyWith({String? id, String? sku, String? name, String? status, String? vendor, String? description, String? shortDescription, String? permalink, String? price, String? regularPrice, String? salePrice, String? maxPrice, String? minPrice, bool? onSale, bool? inStock, double? averageRating, int? totalSales, String? dateOnSaleFrom, String? dateOnSaleTo, int? ratingCount, List<String>? images, String? imageFeature, List<ProductAttribute>? attributes, List<Attribute>? defaultAttributes, List<ProductAttribute>? infors, String? categoryId, String? videoUrl, List<dynamic>? groupedProducts, List<String?>? files, int? stockQuantity, int? minQuantity, int? maxQuantity, bool? manageStock, bool? backOrdered, String? relatedIds, bool? backordersAllowed, Store? store, List<Tag>? tags, List<Category>? categories, List<Map<String, dynamic>>? metaData, List<ProductAddons>? addOns, List<AddonsOption>? selectedOptions, List<VendorAdminVariation>? vendorAdminVariations, List<ProductVariation>? variationProducts, bool? isPurchased, bool? isDownloadable, String? type, String? affiliateUrl, List<ProductVariation>? variations, List<Map<String, dynamic>>? options, BookingModel? bookingInfo, String? idShop, bool? isFeatured, String? vendorAdminImageFeature, List<String>? categoryIds, List<ProductAttribute>? vendorAdminProductAttributes, String? distance, Map? pureTaxonomies, List? reviews, String? featured, bool? verified, String? tagLine, String? priceRange, String? categoryName, String? hours, String? location, String? phone, String? facebook, String? email, String? website, String? skype, String? whatsapp, String? youtube, String? twitter, String? instagram, String? eventDate, String? rating, int? totalReview, double? lat, double? long, List<dynamic>? listingMenu, ListingSlots? slots, bool? isRestricted}) {
    return Product(
        id: id ?? this.id,
        sku: sku ?? this.sku,
        name: name ?? this.name,
        ...
        vendorAdminVariations: vendorAdminVariations ?? this.vendorAdminVariations,
        ...
        vendorAdminImageFeature: vendorAdminImageFeature ?? this.vendorAdminImageFeature,
        categoryIds: categoryIds ?? this.categoryIds,
        vendorAdminProductAttributes: vendorAdminProductAttributes ?? this.vendorAdminProductAttributes,
