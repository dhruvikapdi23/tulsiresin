...
class BookingModel {
  ...
  bool get isEmpty => month == null || day == null || year == null || timeStart == null || idProduct == null;
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'idProduct': idProduct,
      'idOrder': idOrder,
      'staffs': (staffs?.isNotEmpty ?? false) && staffs![0] != null ? staffs?.map((e) => e!.toJson()).toList() : [],
    };
  }
  ...
  Map<String, dynamic> toJsonAPI() {
    ...
    return {
      ...
      'wc_appointments_field_start_date_time': DateTimeUtils.getTimeBooking(timeStart!),
