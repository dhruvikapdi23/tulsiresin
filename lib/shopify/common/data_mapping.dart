class DataMapping {
  ...
  void setMapping(String productPath, String categoryPath, String? locationPath, Map<String, dynamic> productDataMapping, Map<String, dynamic> categoryDataMapping, Map<String, dynamic> categoryImages, Map<String, dynamic> taxonomies, Map<String, dynamic> listingReviewMapping) {
