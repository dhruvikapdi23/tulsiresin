    ...
    return GetBuilder<WishlistController>(builder: (_) {
      return Scaffold(
        appBar: AppBar(
          ...
          centerTitle: true,
          leading: const Icon(Icons.arrow_back_ios).gestures(onTap: () => Get.back()),
        ...
        body: SingleChildScrollView(
          ...
          child: wishListCtrl.cartList.isNotEmpty
              ? Column(
                  children: [
                    const Text('2 Items').fontSize(FontSizes.s14).textColor(appCtrl.appTheme.grayPrimary),
                    const Divider(),
              ...
              : Column(
                  ...
                  children: [
                    Image.asset(
                      imageAssets.noWishlist,
                      height: Sizes.s150,
                    ),
                    Text('No favourites yet.').fontSize(FontSizes.s18).fontWeight(FontWeight.w600),
                    Space(0, 10),
                    Text(
                    ...
                    Space(0, 50),
                    CustomButton(
                      title: CommonFonts().startShopping,
                    ...
                    CustomButton(
                      ...
                      radius: 0,
                      fontColor: appCtrl.appTheme.grayPrimary,
                    ).paddingSymmetric(
                      horizontal: Insets.i20,
                    ),
                  ],
