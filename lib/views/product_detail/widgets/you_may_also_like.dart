...
class YouMayAlsoLike extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<ProductDetailController>(builder: (productDetail) {
      return Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Text(CommonFonts().youMayAlsoLike).fontSize(FontSizes.s18).fontWeight(FontWeight.w600).textColor(appCtrl.appTheme.black),
          Divider(
            color: appCtrl.appTheme.lightGray,
            endIndent: Insets.i100,
          ),
          Space(0, 20),
